...
void IMapPlay::HoverCheck(sf::RectangleShape* button, sf::Text* buttonText) {
...
void IMapPlay::HandleEvents(sf::Event* event) {
...
bool IMapPlay::AISolve(int grid[IceMapGen::MaxSize][IceMapGen::MaxSize])
{
	int row, col;
	...
	for (int value = 1; value <= IceMapGen::MaxSize; value++)
	{
